...
How to use
    ...
    Öffnen Sie eine Konsole (Powershell/bash/...) in dem Ordner, in dem dieses Repo gespeichert werden soll.
    Geben Sie git clone <url> an und downloaden Sie sich das Repository.
    Navigieren Sie in den Ordner mit cd <Ordnername>.
    Öffnen Sie VSCode im aktuellen Verzeichnis mit code ..
...
Block-Quote
    ...
    This is a blockquote... Which can span multiple lines.
